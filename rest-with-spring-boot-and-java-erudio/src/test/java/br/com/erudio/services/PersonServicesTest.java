...
class PersonServicesTest {
    ...
    @SuppressWarnings({"ObviousNullCheck", "DataFlowIssue"}) //Problemas de processo / existem maneiras melhores de resolver
    @Test
    void findById() {
    ...
    @SuppressWarnings({"ObviousNullCheck", "DataFlowIssue"})
    @Test
    void create() {
        Person person = input.mockEntity(1);
